...
class VapeOrderApp:
    ...
    def create_home_page(self):
        ...
        self.stock_table = ttk.Treeview(self.table_frame, columns=columns, show="headings", yscrollcommand=self.scrollbar_y.set)
        self.stock_table.pack(fill="both", expand=True, side="left")
        ...
        # Adjust the size of the table frame to fill the remaining height
        self.home_frame.grid_rowconfigure(1, weight=1)
    ...
    def update_stock_table(self):
        ...
        # Update the height of the stock_table to fill all available space
